...
class NCBIExtractor(BaseArticleExtractor):
    def _extract_sections(self):
        ...
        # Dynamically identify the main content section
        content_div = (
            self.soup.find('section', {'class': 'body main-article-body'}) or
            self.soup.find('div', {'id': 'maincontent'}) or
            self.soup.find('div', {'class': 'article-details'}) or
            self.soup.find('main', {'class': 'article-details'}) or
            self.soup.find('div', {'class': 'article-page'}) or
    ...
    def _combine_main_content(self):
        ...
        main_content_sections = ["title", "abstract", "paper_type", "tables", "introduction", "methods", "search_strategy", "results", "discussion", "conclusion", "image_text"]
        main_content = []
